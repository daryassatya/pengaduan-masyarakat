...
<!-- Vendor JS Files -->
<script src="{{ asset('front-components/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
<script src="{{ asset('front-components/vendor/aos/aos.js') }}"></script>
<script src="{{ asset('front-components/vendor/glightbox/js/glightbox.min.js') }}"></script>
