            ...
            <div class="row g-5">
                ...
                <div class="col-lg-8">
                    ...
                    <article class="blog-details">
                        ...
                        <div class="content">{{ $post->body }}</div><!-- End post content -->
                            ...
                            <ul class="mt-3">
                                <ul>
                                    @foreach ($categories as $category)
                                        <li><a href="{{ route('category.spesific', $category->slug) }}">{{ $category->name }}
                                    ...
                                    <div class="post-item mt-3">
                                        @if ($post->image)
                                            <img src="{{ asset('storage/' . $post->image) }}"
                                                alt="{{ $post->category->name }}" alt="" class="img-fluid">
                                        @else
